           ...
           <div class="card-body">
            <div class="mini-stat">
                ...
                <div class="mini-stat-info text-right">
                    <span class="counter text-primary">{{$usersCount}}</span>
                    Total Students
                </div>
            </div>
           </div>
       ...
       <div class="card">
           <div class="card-body">
            <div class="mini-stat clearfix">
                ...
                <div class="mini-stat-info text-right">
                    <span class="counter text-success">{{$instructorCount}}</span>
                    Total Instructors
                </div>
       ...
       <div class="card">
           <div class="card-body">
            <div class="mini-stat clearfix">
                ...
                <div class="mini-stat-info text-right">
                    <span class="counter text-warning">{{$courseCount}}</span>
                    Total Courses
                </div>
                <div class="clearfix"></div>
            </div>
       ...
       <div class="card">
           <div class="card-body">
            <div class="mini-stat clearfix">
                ...
                <div class="mini-stat-info text-right">
                    <span class="counter text-pink">{{$totalPrice}}</span>
                    Total Paymentt
                </div>
                <div class="clearfix"></div>
            </div>
